...
export function ListFilters({ path, params, statuses, searchLabel, obras }: {
  path: string; params: ListParams; statuses: readonly string[]; searchLabel: string; obras?: { id: string; nombre: string }[]
}) {
  return <form action={path} className="card mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    {obras && obras.length > 0 && (
      <label className="text-sm font-semibold sm:col-span-2">Proyecto
