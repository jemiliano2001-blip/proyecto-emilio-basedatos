...
export function IconFlechaAtras(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M19 12H5" />
...
export function IconImprimir(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M6 9V2h12v7" />
...
export function IconPaquete(props: IconProps) {
  return (
    <svg {...base} {...props}>
...
export function IconBasura(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M3 6h18" />
...
export function IconBitacora(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M8 6h13" />
      <path d="M8 12h13" />
